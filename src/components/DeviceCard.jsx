...
const DeviceCard = ({ device, mode = "control" }) => {
  ...
  if (mode === "detail") {
    return (
      <div className="p-4 bg-[#f8f2f8] border-1 border-[#8771ea] rounded-3xl flex justify-between items-center w-full">
        {/* Value on the left */}
  ...
  return (
    <div className="p-4 bg-[#f8f2f8] border-1 border-[#8771ea] rounded-3xl flex flex-col items-center w-full">
